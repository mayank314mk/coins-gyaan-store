...
function ProductCard({
  ...
  return (
    <article className="flex w-[245px] flex-none flex-col rounded-2xl border border-gray-200 bg-gray-50 p-3.5 shadow-sm transition-all hover:border-gray-300 hover:shadow-md sm:w-[265px] lg:w-auto">
